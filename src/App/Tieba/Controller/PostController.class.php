...
class PostController extends BaseController
{
    ...
    private function getReply($rid)
    {
        ...
        if ($rid != '0') {
            ...
            $html = '<blockquote class="d_quote"><fieldset><legend> 回复 <a class="at j_user_card" data-uid="' . $info['user_id'] . '" target="_blank" href="' . U('Home/main', array('id' => $info['user_id'])) . '">@' . $info['user_name'] . '</a> (' . $info['floor_id']
            . '楼) </legend>
